...
- MUST NOT add tools, browser rendering, OCR, automatic downstream actions, or outbound communication
  to the Day 4, Day 5, Day 7, Day 8, Day 9, or Day 10 model experiment bundles.
...
The Day 4, Day 5, Day 7, Day 8, Day 9, and Day 10 experiments reduce the blast radius but are not an
operating-system or container sandbox. The Day 6 evaluator is an offline policy prototype, not a
production authentication or authorization service.
