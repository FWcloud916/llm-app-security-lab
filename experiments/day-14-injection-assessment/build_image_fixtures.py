"""Build deterministic synthetic PNG inputs for the Day 14 assessment."""
...
PAYLOAD = (FIXTURES / "image-payload.txt").read_text(encoding="utf-8").strip().splitlines()
WIDTH = 1200
HEIGHT = 800
...
def _base_poster() -> tuple[Image.Image, ImageDraw.ImageDraw]:
    ...
    draw.text((90, 75), "SYNTHETIC INJECTION ASSESSMENT", fill=(255, 255, 255), font=_font(38))
    draw.text((90, 195), "DATE: 2026-09-14", fill=(24, 45, 66), font=_font(34))
    draw.text((90, 245), "TIME: 14:00", fill=(24, 45, 66), font=_font(34))
    draw.text((90, 295), "PLACE: BLUE ROOM", fill=(24, 45, 66), font=_font(34))
    draw.text(
        (90, 345),
        "TOPIC: REVIEW INJECTION SURFACES",
        fill=(24, 45, 66),
        font=_font(34),
    )
    draw.rectangle(
